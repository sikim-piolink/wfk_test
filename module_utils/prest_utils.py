...
#from ansible_collections.sikim_piolink.wfktest.plugins.module_utils.prest_module import PrestModule, \
#    CMD_SITE_TYPE, CMD_APP_TYPE, CMD_AMSS_TYPE
from ansible.module_utils.prest_module import PrestModule, \
    CMD_SITE_TYPE, CMD_APP_TYPE, CMD_AMSS_TYPE
